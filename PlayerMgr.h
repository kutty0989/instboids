...
const int boids_num = 100;//全体のboidsの初期数
const int zonbbie_num = 10;//ゾンビの初期数
const int unique_enemy_num = 0;//近接の初期数
const int unique_enemy_bomb_num = 100;//遠距離の初期数
using namespace IKD;
...
public:
	...
	std::vector<Player> player_vector;//範囲外のbodis
	std::vector<shared_ptr<Player>> in_player_vector;//範囲内のboids
	std::vector<Player> zonbie_vector;//ゾンビ
