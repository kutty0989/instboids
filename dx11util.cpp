...
IDXGISwapChain* GetDX11SwapChain() {
	return CDirectXGraphics::GetInstance()->GetSwapChain();
}
...
{
	CDirectXGraphics::GetInstance()->TurnOnLeftScissor();
}
void TurnOnRightScissor()
{
	CDirectXGraphics::GetInstance()->TurnOnRightScissor();
}
void TurnOffScissor()
{
	CDirectXGraphics::GetInstance()->TurnOffScissor();
}
