...
// 法線ベクトルを計算
// ノーマライズ
void Circle::Normalize(XMFLOAT3 vector, XMFLOAT3& Normal) {
	DX11Vec3Normalize(Normal, Normal);
}

// インデックスデータを作成
void Circle::CreateIndex() {
...
// 描画
void Circle::Draw(ID3D11DeviceContext* device) {
