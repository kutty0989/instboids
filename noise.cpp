...
//--------------------------------------------------------------------------------------
// Noise::CalculationNoise()関数：ノイズ計算
//--------------------------------------------------------------------------------------
double Noise::CalculationNoise(double x, double y, double z)
{
...
//--------------------------------------------------------------------------------------
// Noise::Octave()関数：オクターブ
//--------------------------------------------------------------------------------------
double Noise::Octave(double x, double y, double z, int octaves)
{
    double result = 0.0;
    double amp = 1.0;
